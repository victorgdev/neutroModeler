...
var $author$project$Main$init = function (maybeNodes) {
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$Main$emptyModel,
			{
				nodes: A2($elm$core$Maybe$withDefault, _List_Nil, maybeNodes)
			}),
	...
	function (msg, model) {
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$setStorage(newModel.nodes),
						cmds
					])));
	});
var $author$project$Main$Add = {$: 'Add'};
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$Main$checkFormIsEmpty = function (model) {
	return (model.form.label === '') ? true : false;
};
...
var $author$project$Main$viewInput = function (node) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(node.label),
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$Delete(node.id))
							]),
						_List_fromArray(
							[
...
var $author$project$Main$viewKeyedNode = function (node) {
	return _Utils_Tuple2(
		$elm$core$String$fromInt(node.id),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$viewKeyedNode, nodes))
			]));
};
