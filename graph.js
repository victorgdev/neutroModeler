...
var $author$project$NeutroGraph$Model = F3(
	function (drag, graph, simulation) {
		return {drag: drag, graph: graph, simulation: simulation};
	});
...
var $author$project$NeutroGraph$h = 504;
...
var $author$project$NeutroGraph$initializeNode = function (ctx) {
	return {
...
var $author$project$NeutroGraph$miserablesGraph = A2(
...
var $author$project$NeutroGraph$w = 990;
var $author$project$NeutroGraph$init = function (_v0) {
	var link = function (_v1) {
		var from = _v1.from;
		var to = _v1.to;
		return _Utils_Tuple2(from, to);
	};
	var graph = A2($elm_community$graph$Graph$mapContexts, $author$project$NeutroGraph$initializeNode, $author$project$NeutroGraph$miserablesGraph);
	var forces = _List_fromArray(
		[
			...
			A2($gampleman$elm_visualization$Force$center, $author$project$NeutroGraph$w / 2, $author$project$NeutroGraph$h / 2)
		]);
	return _Utils_Tuple2(
		A3(
			$author$project$NeutroGraph$Model,
			$elm$core$Maybe$Nothing,
			graph,
			$gampleman$elm_visualization$Force$simulation(forces)),
		$elm$core$Platform$Cmd$none);
};
var $author$project$NeutroGraph$DragAt = function (a) {
	return {$: 'DragAt', a: a};
};
var $author$project$NeutroGraph$DragEnd = function (a) {
	return {$: 'DragEnd', a: a};
};
var $author$project$NeutroGraph$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$NeutroGraph$subscriptions = function (model) {
	var _v0 = model.drag;
	if (_v0.$ === 'Nothing') {
		return $gampleman$elm_visualization$Force$isCompleted(model.simulation) ? $elm$core$Platform$Sub$none : $elm$browser$Browser$Events$onAnimationFrame($author$project$NeutroGraph$Tick);
	} else {
				...
				[
					...
					A2(
						...
						A2(
							...
							$author$project$NeutroGraph$DragAt),
					...
					A2(
						...
						A2(
							...
							$author$project$NeutroGraph$DragEnd),
						$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$eventDecoder)),
					$elm$browser$Browser$Events$onAnimationFrame($author$project$NeutroGraph$Tick)
				]));
	}
};
var $author$project$NeutroGraph$Drag = F3(
...
var $author$project$NeutroGraph$updateContextWithValue = F2(
...
var $author$project$NeutroGraph$updateGraphWithList = function () {
	var graphUpdater = function (value) {
		return $elm$core$Maybe$map(
			function (ctx) {
				return A2($author$project$NeutroGraph$updateContextWithValue, ctx, value);
			});
	};
...
var $author$project$NeutroGraph$updateNode = F2(
	function (_v0, nodeCtx) {
		var x = _v0.a;
		var y = _v0.b;
		var nodeValue = nodeCtx.node.label;
		return A2(
			$author$project$NeutroGraph$updateContextWithValue,
			nodeCtx,
			_Utils_update(
				nodeValue,
				{x: x, y: y}));
	});
var $author$project$NeutroGraph$update = F2(
	function (msg, model) {
		var drag = model.drag;
			...
			case 'Tick':
				...
				if (drag.$ === 'Nothing') {
					return A3(
						$author$project$NeutroGraph$Model,
						drag,
						A2($author$project$NeutroGraph$updateGraphWithList, graph, list),
						newState);
				} else {
					...
					return A3(
						...
						A3(
							...
							index,
							$elm$core$Maybe$map(
								$author$project$NeutroGraph$updateNode(current)),
							A2($author$project$NeutroGraph$updateGraphWithList, graph, list)),
						newState);
				}
			case 'DragStart':
				...
				return A3(
					$author$project$NeutroGraph$Model,
					$elm$core$Maybe$Just(
						A3($author$project$NeutroGraph$Drag, xy, xy, index)),
					graph,
					simulation);
			case 'DragAt':
				var xy = msg.a;
				if (drag.$ === 'Just') {
					...
					return A3(
						$author$project$NeutroGraph$Model,
						$elm$core$Maybe$Just(
							A3($author$project$NeutroGraph$Drag, start, xy, index)),
						A3(
							$elm_community$graph$Graph$update,
							index,
							$elm$core$Maybe$map(
								$author$project$NeutroGraph$updateNode(xy)),
							graph),
						$gampleman$elm_visualization$Force$reheat(simulation));
				} else {
					return A3($author$project$NeutroGraph$Model, $elm$core$Maybe$Nothing, graph, simulation);
				}
			default:
				var xy = msg.a;
				if (drag.$ === 'Just') {
...
var $author$project$NeutroGraph$linkElement = F2(
	function (graph, edge) {
		var target = A2(
			$elm$core$Maybe$withDefault,
...
var $elm_community$typed_svg$TypedSvg$Attributes$fill = A2(
	...
	$elm_community$typed_svg$TypedSvg$TypesToStrings$paintToString);
var $author$project$NeutroGraph$DragStart = F2(
	function (a, b) {
...
var $author$project$NeutroGraph$onMouseDown = function (index) {
	return $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onDown(
		A2(
			...
			$author$project$NeutroGraph$DragStart(index)));
};
...
var $author$project$NeutroGraph$nodeElement = function (node) {
	return A2(
		$elm_community$typed_svg$TypedSvg$circle,
		_List_fromArray(
			[
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$r(2.5),
				...
				$author$project$NeutroGraph$onMouseDown(node.id),
...
var $author$project$NeutroGraph$view = function (model) {
	return A2(
		$elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$NeutroGraph$w, $author$project$NeutroGraph$h)
			]),
		_List_fromArray(
			[
				A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$NeutroGraph$linkElement(model.graph),
				...
				A2(
					$elm$core$List$map,
					$author$project$NeutroGraph$nodeElement,
					$elm_community$graph$Graph$nodes(model.graph)))
			]));
};
var $author$project$NeutroGraph$main = $elm$browser$Browser$element(
	{
		init: $author$project$NeutroGraph$init,
		subscriptions: $author$project$NeutroGraph$subscriptions,
		update: F2(
			function (msg, model) {
				return _Utils_Tuple2(
					A2($author$project$NeutroGraph$update, msg, model),
					$elm$core$Platform$Cmd$none);
			}),
		view: $author$project$NeutroGraph$view
	});
_Platform_export({'NeutroGraph':{'init':$author$project$NeutroGraph$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"NeutroGraph.Msg","aliases":{"Graph.NodeId":{"args":[],"type":"Basics.Int"}},"unions":{"NeutroGraph.Msg":{"args":[],"tags":{"DragStart":["Graph.NodeId","( Basics.Float, Basics.Float )"],"DragAt":["( Basics.Float, Basics.Float )"],"DragEnd":["( Basics.Float, Basics.Float )"],"Tick":["Time.Posix"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});}(this));